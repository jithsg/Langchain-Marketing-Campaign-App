...
def getLLMResponse(query, age_option, tasktype_option):
    ...
    query = form_input
    print(new_prompt_template.format(userInput=query, age_option=age_option, tasktype_option=tasktype_option))
    response =llm(new_prompt_template.format(userInput=query, age_option=age_option, tasktype_option=tasktype_option))
    print(response)
    return response
